...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"graph/graph_scc.hpp\"\n\n#line 2 \"graph/graph_base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge\n{\n    int from, to;\n    T cost;\n  \
  ...
  verifiedWith: []
documentation_of: graph/graph_scc.hpp
layout: document
redirect_from:
- /library/graph/graph_scc.hpp
- /library/graph/graph_scc.hpp.html
